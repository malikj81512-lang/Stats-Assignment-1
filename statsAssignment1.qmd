...
gives a clearer picture of the effect of solar on consumption and explains the shape of the unstratified histogram.
...
# Household size
red_model_household <- update(full_model, .~. - household_size, data = en_dat)
anova(red_model_household, full_model)
