...
1.  Observed relationships: There appears to be a negative relationship between electricity consumption and solar installation with solar installation decreasing average electricity consumption. There also appears to be a negative relationship between consumption and energy efficiency as improved energy efficiency is associated with lower average consumption. The categorical variable boxplot of the day of the week against consumption indicates that median electricity consumption is higher on weekends.
...
3.  Outliers: There are two potential outlying observations of low consumption on Saturdays as well as a potential outlying observation of high consumption in a household without solar installed. There are also two potential outlying observations of low consumption in 1 person households and four of high consumption in 5 person households.
...
ubs <- confidence_ints[19:36] |> signif(4)
...
#| echo: false
fit_results <- tibble(
  coeffs = c("(Intercept)", "Outside temperature", "Humidity", "Wind speed", "Household size", "Appliance index", "Energy efficiency (Average)", "Energy efficiency (Good)", "Energy efficiency (Excellent)", "Solar installed (Yes)", "Day of week (Tuesday)", "Day of week (Wednesday)", "Day of week (Thursday)", "Day of week (Friday)", "Day of week (Saturday)", "Day of week (Sunday)", "Holiday", "Interaction term (outside temperature against humidity)"),
...
kable(nested_anova_results, col.names = c("Explanatory variable", "F value", "p-value"), caption = "Results of hypothesis tests conducted")
...
As the true value of $\beta_{1}$ increased, the probability of the null hypothesis $\beta_{1}=0$ being rejected increased, and hence the proportion of rejections over 1000 simulations increased. Therefore, as the true value of $\beta_{1}$ increased, the estimated power of the test increased significantly. For true $\beta_{1}=10$, the estimated power was 1.000, meaning every test recorded a rejection.
...
For a small sample size, the estimated power of the mis-specified linear model was quite low, while the estimated power of the correctly specified exponential model was much higher. As sample size increased, the estimated power of both models increased significantly. A sample size of 50 yielded an estimated power of 1.000 for the exponential model, and 0.999 for the linear model, suggesting that, for a large enough sample size, a mis-specified linear model could provide almost equal power as an exponential model for data that actually followed an exponential distribution.
