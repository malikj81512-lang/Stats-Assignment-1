...
Our analysis does not provide sufficient evidence for an interaction between light and heat having an effect on quality (p-val = 0.265).
...
Our results showed strong evidence for the main effects of heat and light having an effect on the quality of chilli growth. We found that light level 4 produced the highest mean response, however level 3 produced the highest median response. 
Our tests showed that heat level 3 resulted in the highest average and median response.
Our results that the interaction between heat and light was not significant, allowing us to conclude that the heat and light settings that produce the highest quality chillies are simply those which individually produce the best response.

Given that additional lighting and heating is expensive, and 
...
Since the interactions between light, heat and variety were not significant, for each variety, the c
