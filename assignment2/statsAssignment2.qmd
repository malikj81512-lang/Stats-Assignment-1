...
These goals will be tackled through 
an analysis of variance of this exploratory experiment. 
...
final design idea: 
- whole block: season 
- sub block: greenhouse-side block 
- randomise for variety across season block 
- randomise for light and heat across(16 combinations) across the greenhouses in a latin square design to block for location within the greenhouse (n-s, e-w)


hypotheses (i honestly don't know how i should be defining these... possibly using contrasts but not sure. also not sure how i should be setting up the model but i am busy doing more stats and reading to figure it all out): 
