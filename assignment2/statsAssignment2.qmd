...
mydesign2$season <- as.factor(mydesign$season)
#mydesign2
...
```{r boxplot 1, fig.cap = "Boxplot of season", echo = FALSE}
...
```{r boxplot 1, fig.cap = "Boxplot of greenhouse", echo = FALSE}
...
```{r boxplot 1, fig.cap = "Boxplot of side", echo = FALSE}
